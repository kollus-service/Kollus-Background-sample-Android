...
//        initVideoView();
    ...
    public void addView(View child, ViewGroup.LayoutParams params) {
        if (child instanceof SurfaceView) {
            LogUtil.d(TAG, "addVideoView in SurfaceView");
            ...
            LogUtil.d(TAG, "addVideoWaterMark");
    ...
    public void stopPlayback() {
        if (mMediaPlayer != null) {
            LogUtil.d(TAG, "MediaPlayer Stop Call");
            mMediaPlayer.stop();
            LogUtil.d(TAG, "MediaPlayer Release Call");
    ...
    private void openVideo() {
        if ((mUri == null && mMediaContentKey == null)/*|| mSurfaceHolder == null*/ || !mVideoSurfaceReady) {
            ...
            LogUtil.e(TAG, "Not Ready for playback yet.");
            return;
        }
        ...
        try {
            mMediaPlayer = new MediaPlayer(mContext, mStorage, /*KollusConstants.SERVER_PORT*/ 1234);
...
//                mHandler.postDelayed(mSoundFadeOut, FADEOUT_INTERVAL);
                    if (mSeekPosition != mCurrentPosition) {
                        LogUtil.d(TAG, "Executing queued seekTo : " + mCurrentPosition);
                        mSeekPosition = -1;
                        if (mSeekExact)
                        ...
                        LogUtil.d(TAG, "All seekTo complete - return to regularly scheduled program");
    ...
    private VideoWindowListener getSurfaceListener() {
        return new VideoWindowListener() {
            ...
            public void onVideoSurfaceChanged(SurfaceHolder holder, int format, int width, int height) {
                // TODO Auto-generated method stub
                LogUtil.w(TAG, "onVideoSurfaceChanged");
            ...
            public void onVideoSurfaceCreated(SurfaceHolder holder) {
                LogUtil.w(TAG, "onVideoSurfaceCreated");
                mVideoSurfaceReady = true;
                if (mCurrentState == STATE_IDLE) {
                    openVideo();
                    LogUtil.w(TAG, "onVideoSurfaceCreated _ openVideo");
                } else {
                    LogUtil.w(TAG, "onVideoSurfaceCreated _ openVideo xxxxx");
                    //etlim 20170831 STATE_ERROR ==>  mMediaPlayer release Issue.
                    //  if((mCurrentState != STATE_ERROR) && (mMediaPlayer != null)) {
                    if (mMediaPlayer != null) {
                        LogUtil.w(TAG, "onVideoSurfaceCreated _ openVideo xxxxx mMediaPlayer !=null");
            ...
            public void onVideoSurfaceDestroyed(SurfaceHolder holder) {
                // TODO Auto-generated method stub
                LogUtil.w(TAG, "onVideoSurfaceDestroyed");
    ...
    private TextureView.SurfaceTextureListener getSurfaceListener21() {
        return new TextureView.SurfaceTextureListener() {
            ...
            public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int width, int height) {
                // TODO Auto-generated method stub
                LogUtil.w(TAG, "onSurfaceTextureSizeChanged");
                mSurfaceWidth = width;
                mSurfaceHeight = height;
            }
            ...
            public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
                LogUtil.w(TAG, "onSurfaceTextureAvailable");
                mVideoSurfaceReady = true;
            ...
            public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
                // TODO Auto-generated method stub
                LogUtil.w(TAG, "onSurfaceTextureDestroyed");
                mVideoSurfaceReady = false;
    ...
    private CaptureDetectLister mCaptureDetectLister =
            new CaptureDetectLister() {
                public void onCaptureDetected(String appName, String packageName) {
                    LogUtil.d(TAG, String.format("Capture Detected (%s, %s)", appName, packageName));
                    mMediaPlayer.release();
                    mMediaPlayer = null;
                    mCurrentState = STATE_IDLE;
                }
...
//            mAudioManager.setStreamVolume(AudioManager.STREAM_MUSIC, 0, 0);
            ...
            if (mSeekPosition < 0) {
                ...
                LogUtil.d(TAG, "Seek in progress - queue up seekTo :%d" + msec);
            }
...
//            mAudioManager.setStreamVolume(AudioManager.STREAM_MUSIC, 0, 0);
    ...
    private boolean isInPlaybackState() {
        LogUtil.d(TAG, String.format("mCurrentState %d in isInPlaybackState", mCurrentState));
